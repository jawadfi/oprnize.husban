<x-filament-panels::page>
    ...
    <div>
        @if (!$this->selectedCompanyId)
            ...
            @endif
        @else
            {{-- STEP 2: Category Selection (after company is chosen) --}}
            <div class="flex items-center gap-3 mb-6">
                <button wire:click="resetCompany" class="inline-flex items-center gap-2 px-4 py-2 text-sm font-medium text-gray-600 bg-white border border-gray-200 rounded-full hover:bg-gray-50 transition-colors">
            ...
            <div class="grid grid-cols-1 md:grid-cols-{{ $visibleCards }} gap-8 mt-8">
                {{-- Contracted Payroll --}}
