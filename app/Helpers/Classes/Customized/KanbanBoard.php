...
namespace App\Helpers\Classes\Customized;


use Filament\Forms\Contracts\HasForms;
use Illuminate\Database\Eloquent\Builder;
use Illuminate\Support\Collection;
use Modules\University\App\Filament\Resources\SubjectResource;
use Mokhosh\FilamentKanban\Concerns\HasEditRecordModal;
use Mokhosh\FilamentKanban\Concerns\HasStatusChange;

abstract class KanbanBoard extends \Filament\Resources\Pages\Page implements HasForms
{
